...
if __name__ == '__main__':
    ...
    np.save('30TR20/adj_matrix.npy', A)
    ...
    np.save('30TR20/train_data.npy', train_data)
    np.save('30TR20/train_label.npy', train_label)
    np.save('30TR20/test_data.npy', test_data)
    np.save('30TR20/test_label.npy', test_label)
    np.save('30TR20/val_data.npy', val_data)
    np.save('30TR20/val_label.npy', val_label)
