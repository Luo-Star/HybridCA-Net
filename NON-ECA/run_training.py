...
train_data = torch.from_numpy(np.load('/home/lwc/6-7/first_data/npy/30TR20/train_data.npy')).float()
train_label = torch.from_numpy(np.load('/home/lwc/6-7/first_data/npy/30TR20/train_label.npy')).float()
val_data = torch.from_numpy(np.load('/home/lwc/6-7/first_data/npy/30TR20/val_data.npy')).float()
val_label = torch.from_numpy(np.load('/home/lwc/6-7/first_data/npy/30TR20/val_label.npy')).float()
...
for epoch in range(200):  # number of mini-batches
    ...
    with torch.no_grad():
        ...
        if best_acc < val_accurate:
            ...
            torch.save(net.state_dict(), '/home/lwc/6-7/NON-ECA/output/first/30TR20/non_eca_30TR20_best_checkpoint.pth')
        ...
        print(results)
        with open('/home/lwc/6-7/NON-ECA/output/first/30TR20/non_eca_30TR20_final.txt', 'a+') as f:
            time = datetime.now()
